...
% 
                    ...
                    disp(['Time: ',num2str(toc),'s, Computing Blob ',num2str(n),' of ', num2str(CC.NumObjects), '. EquivRadius: ', num2str((numel(CC.PixelIdxList{n}).^0.33)),', Direct: ', num2str(mean(directTheta)), ', Kearney: ', num2str(quantile(thetaMacroKearney,0.5)), ', Sun: ', num2str(mean(180-thetaMacroSun)), ', Actual: ', num2str(mean(thetaActual))])                    
                    clf;
